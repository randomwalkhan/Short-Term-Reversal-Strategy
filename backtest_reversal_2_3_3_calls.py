...
PLOT_PATH = OUTPUT_DIR / "reversal_2_3_3_call_backtest_equity.png"
TRADES_PATH = OUTPUT_DIR / "reversal_2_3_3_call_backtest_trades.csv"
EQUITY_PATH = OUTPUT_DIR / "reversal_2_3_3_call_backtest_equity.csv"
...
def main() -> None:
    ...
    plot_equity_curve(equity_df, trades_df, "Reversal 2.3.3 Call Backtest")
