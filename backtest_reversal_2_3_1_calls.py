...
PLOT_PATH = OUTPUT_DIR / "reversal_2_3_1_call_backtest_equity.png"
TRADES_PATH = OUTPUT_DIR / "reversal_2_3_1_call_backtest_trades.csv"
EQUITY_PATH = OUTPUT_DIR / "reversal_2_3_1_call_backtest_equity.csv"
...
def main() -> None:
    ...
    tickers = presets["nasdaq_spy_filtered"]
    ...
    equity_df, trades_df, summary = summarize_backtest("nasdaq_spy_filtered", tickers, history_cache)

    OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
    equity_df.to_csv(EQUITY_PATH, index=False)
    trades_df.to_csv(TRADES_PATH, index=False)
    plot_equity_curve(equity_df, trades_df, "Reversal 2.3.1 Call Backtest")
