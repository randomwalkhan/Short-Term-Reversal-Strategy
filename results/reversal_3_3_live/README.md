...
ticker asset_type execution_mode          instrument entry_trade_date  business_days_held  units  cash_spent  current_position_value  entry_price  current_price  entry_spot  current_spot current_price_source  current_exit_signal_price current_exit_signal_source  current_quote_reliable  unrealized_pnl  unrealized_return_pct  success_rate  matched_signals  current_drop_pct  entry_iv_pct  current_iv_pct  rolling_sigma_20d_pct  option_open_interest  option_volume  option_spread_pct option_liquidity_status
  PAYX     option         option PAYX260717C00100000       2026-06-11                   0     27     14175.0                 14175.0         5.25           5.25      100.46        100.46          bid_ask_mid                       5.25                bid_ask_mid                    True             0.0                    0.0         100.0               22              0.63         41.79           41.79                  34.22                 685.0          131.0                0.1                      ok
```
...
ticker  success_rate_%  matched_signals  current_drop_%  target_rebound_$  target_price  rolling_sigma_20d_%  timing_score   timing_status  early_entry_score  early_reclaim_%  early_recovery_stability_score  trend_return_10d_%  trend_slope_%/day                trend_health_status  call_candidate  early_entry_candidate
  PAYX          100.00               22            0.63              0.45        100.91                34.22         0.573            pass              0.758             73.4                           0.575                5.18              0.308                                 ok            True                  False
  INTU           73.91               23            2.14              4.26        282.40               101.53         0.701            pass              0.290             44.4                           0.506              -11.14             -1.744 downtrend_blocked_slope_and_streak           False                  False
   TRI           80.00               20            1.23              0.71         81.66                68.04         0.652            pass              0.311             59.8                           0.465               -4.19             -0.791 downtrend_blocked_slope_and_streak           False                  False
  MSFT           50.00                6            2.37              6.60        394.53                36.94         0.514            pass              0.140             29.4                           0.335               -9.15             -1.401 downtrend_blocked_slope_and_streak           False                  False
  CTSH           89.66               29            1.05              0.38         51.65                46.99         0.511            pass              0.659             74.5                           0.578               -4.80             -0.777 downtrend_blocked_slope_and_streak           False                  False
  TEAM           88.46               26            3.12              2.00         90.68                86.53         0.506            pass              0.512             43.1                           0.529               -4.94             -1.560 downtrend_blocked_slope_and_streak           False                  False
  WDAY           87.50               16            3.68              3.54        135.95                67.65         0.492 below_threshold              0.381             30.5                           0.258                1.85             -0.532                                 ok           False                  False
   ADP           97.30               37            0.47              0.76        230.77                32.69         0.488 below_threshold              0.857             76.0                           0.583                4.62              0.324                                 ok           False                  False
  SNPS           86.21               29            1.13              3.65        458.97                48.54         0.486 below_threshold              0.540             66.4                           0.719               -5.27             -0.709            downtrend_blocked_slope           False                  False
  CPRT           92.11               38            0.59              0.13         31.30                31.19         0.452 below_threshold              0.741             62.2                           0.447               -6.33             -0.525 downtrend_blocked_slope_and_streak           False                  False
  META           80.56               36            0.58              2.33        569.98                37.32         0.452 below_threshold              0.462             76.2                           0.671              -10.65             -1.039 downtrend_blocked_slope_and_streak           False                  False
  COST           78.95               38            0.39              2.70        982.21                26.59         0.452 below_threshold              0.413             60.4                           0.396               -1.58              0.141                                 ok           False                  False
```
