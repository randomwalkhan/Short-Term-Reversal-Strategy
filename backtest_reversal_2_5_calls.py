...
OUTPUT_DIR = Path.cwd() / "results" / "reversal_2_5"
PLOT_PATH = Path.cwd() / "assets" / "reversal_2_5_call_backtest_equity.png"
TRADES_PATH = OUTPUT_DIR / "reversal_2_5_call_backtest_trades.csv"
EQUITY_PATH = OUTPUT_DIR / "reversal_2_5_call_backtest_equity.csv"
...
def main() -> None:
    ...
    plot_equity_curve(equity_df, trades_df, "Reversal 2.5 Call Backtest")
