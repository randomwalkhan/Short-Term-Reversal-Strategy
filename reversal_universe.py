...
CURATED_ETF_OVERLAYS = ("SOXL", "UPRO", "DRAM")
...
def build_named_universe_map(
    ...
    curated_etfs = {normalize_symbol(ticker) for ticker in CURATED_ETF_OVERLAYS}
    ...
    return {
        ...
        "qqq_plus_leverage_etfs": sorted(qqq_filtered | curated_etfs),
    }
