...
LABEL = "com.randomwalkhan.reversal-3-3"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Install the Reversal 3.3 launchd schedule.")
...
def main() -> None:
    ...
    log_dir = args.project_dir / "results" / "reversal_3_3_live"
    ...
    plist_data = {
        ...
        "ProgramArguments": [
            args.python_bin,
            str((args.project_dir / "reversal_3_3_live.py").resolve()),
        ],
    ...
    print("Every 5 minutes on weekdays. Regular-session logic remains unchanged; off-hours scans continue marking open positions, while legacy share positions from older versions are still managed until flat.")
