...
LABEL = "com.randomwalkhan.reversal-3-1"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Install the Reversal 3.1 launchd schedule.")
...
def main() -> None:
    ...
    log_dir = args.project_dir / "results" / "reversal_3_1_live"
    ...
    plist_data = {
        ...
        "ProgramArguments": [
            args.python_bin,
            str((args.project_dir / "reversal_3_1_live.py").resolve()),
        ],
